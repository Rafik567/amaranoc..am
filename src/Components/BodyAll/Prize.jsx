        ...
        shadow-[0px_15px_50px_rgba(255,255,255,0.8)] bg-gray-100 transition-all duration-300 w-[600px]"
          ...
          hover:text-orange-500 transition-all duration-300"
            ...
            <div className=" mt-[20px] flex justify-center  items-center">
                ...
                <strong className=" px-5 xs:px-10 md:px-20 w-max text-[26px] xs:text-h4 sm:text-h3 md-max:text-h2 text-secondary !font-armHmk z-[1] undefined">Թեժ առաջարկներ</strong >
            </div>
            <BestOffers/>
            <Post/>
        </>
